...
public class BitFloor2{
    ...
    public BitFloor2(){
        ...
        try{
            ...
            URL icbitSite = new URL("https://feed.bitfloor.com/socket.io/1/?t=1344645274234");
            BufferedReader in = new BufferedReader(new InputStreamReader(icbitSite.openStream()));
            
            String topLine = null;
            String inputLine;
            while ((inputLine = in.readLine()) != null && topLine == null){
                topLine = inputLine;
            }
            in.close();
            ...
            socket2 = new de.roderick.weberknecht.WebSocketConnection(new URI("wss://feed.bitfloor.com/socket.io/1/websocket/" + foo));
